package com.tingyun.config.shiro;

import com.tingyun.shiro.MyShiroRealm;
...
public class ShiroConfiguration {
    ...
    public SecurityManager securityManager() {
        ...
        //诸如缓存策略
        defaultWebSecurityManager.setCacheManager(ehCacheManager());//这个如果执行多次，也是同样的一个对象;
        //注入记住我管理器;
