...
import com.tingyun.bean.SysPermission;
import com.tingyun.bean.SysRole;
...
public class MyShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        SimpleAuthenticationInfo authenticationInfo =
                new SimpleAuthenticationInfo(userInfo, userInfo.getPassword(),
     ...
     * 调用clearCached方法；
     * :Authorization 是授权访问控制，用于对用户进行的操作授权，证明该用户是否允许进行当前操作，
     * 如访问某个链接，某个资源文件等。
     *
     * @param principals
     * @return
